...
// add shortage of ingredients to file
void addIngredientsInShortageToFile();

// read ingredients in shortage from file

void readIngredientsInShortageFromFile();
// excess of ingredients
...
// add excess ingredients to file
void addIngredientsInExcessToFile();

// read excess ingredients from file
...
main()
{
    ...
    readIngredientsFromFile();
    readFlavorsFromFile();
    readIngredientsInShortageFromFile();
    readIngredientsInExcessFromFile();
    readFeedbackFromFile();
    readingIngredientChangeRequestFromFile();
...
void adminInterface()
{
    ...
    cout << "13 View employees' suggestions" << endl;
    cout << "14 Add user: " << endl;
    cout << "15 Update user info" << endl;
    cout << "16 View user info" << endl;
    cout << "17 Delete user info" << endl;
    cout << "18 Delete ingredient from the table" << endl;
    cout << "19 Add a flavor into the system" << endl;
    cout << "20 Delete a flavor from the system" << endl;
    cout << "21 View flavors in system" << endl;
    cout << endl;
...
void employeeInterface()
{
    ...
    cout << "7  Log shortage of ingredients " << endl;
    ...
    cout << "13 Log excess of ingredients" << endl;
    cout << endl;
...
string adminChoice()
{
    ...
    while (true)
    {
        ...
        if (!(choice == "0" || choice == "1" || choice == "2" || choice == "3" || choice == "4" || choice == "5" || choice == "6" || choice == "7" || choice == "8" ||
         choice == "9" || choice == "10" || choice == "11" || choice == "12" || choice == "13" || choice == "14" || choice == "15" || choice == "16" || choice == "17" || choice == "18" || choice == "19" || choice == "20" || choice == "21"))
        {
...
void viewManufacturingOrders()
{
    system("cls");
    header();
    subHeader("Manufacturing Order view");
    cout << "Serial number:"
         << "\t"
         << "Flavor:"
         << "\t\t"
...
void viewRecommendedIngredients()
{
    system("cls");
    header();
    subHeader("Recommended Products");
    for (int i = 0; i < numberOfRequests; i++)
    {
        cout << i + 1 << "\t\t" << ingredientRequest[i] << "\t\t" << ingredientRequestQuantity[i] << endl;
    }
    for (int i = 0; i < numberOfIngredientsInShortage; i++)
    {
        cout << numberOfRequests + i << "\t\t" << ingredientsInShortage[i] << "\t\t" << quantityInShortage[i] << endl;
    }
    cout << "Press any key to continue" << endl;
    getch();
}
...
void viewExcessIngredients()
{
    system("cls");
    header();
    subHeader("Excess Products");
    for (int i = 0; i < numberOfIngredientsInExcess; i++)
    {
        cout << i + 1 << "\t\t" << ingredientsInExcess[i] << "\t\t" << quantityInExcess[i] << endl;
    }
    cout << "Press any key to continue" << endl;
    getch();
}
...
void addIngredientsInShortage()
{
    ...
    while (true)
    {
        ...
        if (stringNumberValidate(quantityByWhichItWasShort))
        {
            ...
            addIngredientsInShortageToFile();
        }
        else
        {
            system("cls");
...
// add ingredients in shortage to file
void addIngredientsInShortageToFile()
{
    fstream file;
    file.open("shortageOfIngredients.txt", ios::out);
    for (int i = 0; i < numberOfIngredientsInShortage; i++)
    {
        file << ingredientsInShortage[i] << "," << quantityInShortage[i] << endl;
    }
    file.close();
}
...
void readIngredientsInShortageFromFile()
{
    fstream file;
    string line;
    file.open("shortageOfIngredients.txt", ios::in);
    while (!file.eof())
    {
        getline(file, line);
        if (line == "")
        ...
        ingredientsInShortage[numberOfIngredientsInShortage] = parse(line, 1);
        quantityInShortage[numberOfIngredientsInShortage] = stoi(parse(line, 2));
        numberOfIngredientsInShortage++;
    }
    file.close();
}

// add excess ingredients
void addIngredientsInExcess()
{
    string ingredientInExcess, quantityByWhichItWasInExcess;
    while (true)
    {
        system("cls");
        header();
        subHeader("ingredients in excess");
        cout << "Enter ingredient in excess: (Enter 0 to go back)";
        cin >> ingredientInExcess;

        if (ingredientInExcess == "0")
        {
            break;
        }
        if (isIngredientInTheTable(ingredientInExcess))
        {
            ingredientsInExcess[numberOfIngredientsInExcess] = ingredientInExcess;
        }
        else
        {
            system("cls");
        ...
        cout << "Enter quantity by which it was in shortage: ";
        cin >> quantityByWhichItWasInExcess;

        if (stringNumberValidate(quantityByWhichItWasInExcess))
        {
            quantityInExcess[numberOfIngredientsInExcess] = stoi(quantityByWhichItWasInExcess);
            numberOfIngredientsInExcess++;
            addIngredientsInExcessToFile();
        }
        else
        {
            system("cls");
...
{
    fstream file;
    file.open("excessOfIngredients.txt", ios::out);
    for (int i = 0; i < numberOfIngredientsInExcess; i++)
    {
        file << ingredientsInExcess[i] << "," << quantityInExcess[i] << endl;
    }
    file.close();
}
...
void readIngredientsInExcessFromFile()
{
    fstream file;
    string line;
    file.open("excessOfIngredients.txt", ios::in);
    while (!file.eof())
    {
        getline(file, line);
        if (line == "")
        ...
        ingredientsInExcess[numberOfIngredientsInShortage] = parse(line, 1);
        quantityInExcess[numberOfIngredientsInShortage] = stoi(parse(line, 2));
        numberOfIngredientsInExcess++;
    }
    file.close();
}
...
void viewFeedbackFromEmployee()
{
    ...
    while (true)
    {
        ...
        cout << endl;
        cout << "Enter serial number for detail view: (Enter 0 to go back)";
        ...
        if (stringNumberValidate(serialNumberForDetail))
        {
            ...
            {
                detailFeedbackView(stoi(serialNumberForDetail) - 1);
            }
            else
            {
...
{
    system("cls");
    cout << employeeFeedbacks[serialNumber] << endl
         << endl;
    cout << "Press any key to continue: " << endl;
    getch();
}
...
void addFeedbackToFile()
{
    ...
    for (int i = 0; i < numberOfFeedbacksAdded; i++)
    {
        file << feedbackEmployeeName[i] << "," << employeeFeedbacks[i] << endl;
    }
    file.close();
}
...
void readFeedbackFromFile()
{
    ...
    while (!file.eof())
    {
        ...
        feedbackEmployeeName[numberOfFeedbacksAdded] = parse(line, 1);
        employeeFeedbacks[numberOfFeedbacksAdded] = parse(line, 2);
...
void addRequests(string employeeUsername)
{
    ...
    while (true)
    {
        ...
        addIngredientChangeRequestToFile();
        system("cls");
...
// add ingredient change requests to file
void addIngredientChangeRequestToFile()
{
    fstream file;
    file.open("requestInChangingRecipeIngredients.txt", ios::out);
    for (int i = 0; i < numberOfRequestsForChangeInRecipes; i++)
    {
        file << requestedIngredientChangesInRecipes[i] << "," << nameOfEmployeesWhoRequestedTheAddition[i] << endl;
    }
    file.close();
}
// reading ingredient change requests from file
void readingIngredientChangeRequestFromFile()
{
    fstream file;
    string line;
    file.open("requestInChangingRecipeIngredients.txt", ios::in);
    while (!file.eof())
    {
        getline(file, line);
        if (line == "")
        ...
        requestedIngredientChangesInRecipes[numberOfRequestsForChangeInRecipes] = parse(line, 1);
        nameOfEmployeesWhoRequestedTheAddition[numberOfRequestsForChangeInRecipes] = parse(line, 2);
        numberOfRequestsForChangeInRecipes++;
    }
    file.close();
}
